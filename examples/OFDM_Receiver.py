...
# Title: Ofdm Receiver
# Generated: Fri Apr 13 20:43:52 2018
##################################################
...
from top_block import top_block  # grc-generated hier_block
import OFDM
import sip
from gnuradio import qtgui
...
class OFDM_Receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_0.set_y_axis(-0.5, 2)
        ...
        self.window_layout_1.addWidget(self._qtgui_time_sink_x_0_0_win)
        ...
        self.ofdm_phy_rx_hier = top_block()
        ...
        self.OFDM_MAC_OFDM_0 = OFDM.MAC_OFDM((0x01, 0x02, 0x03, 0x04, 0x05, 0x06), (0x01, 0x02, 0x03, 0x04, 0x06, 0x07))
        ...
        self.connect((self.OFDM_PHY_OFDM_0, 0), (self.ofdm_phy_rx_hier, 0))
        ...
        self.connect((self.ofdm_phy_rx_hier, 0), (self.blocks_uchar_to_float_0_0, 0))
